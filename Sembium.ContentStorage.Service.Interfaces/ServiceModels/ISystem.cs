...
namespace Sembium.ContentStorage.Service.ServiceModels
{
    public interface ISystem
    {
        ...
        Task<string> MaintainContainerAsync(string containerName, string prefix, string authenticationToken, CancellationToken cancellationToken);
        Task CompactContainerAsync(string containerName, string authenticationToken, CancellationToken cancellationToken);
