...
Once you have edited your template and code you can use the following command lines to deploy your application from the command line (these examples assume the project name is *Sembium.ContentStorage.Service.AmazonLambda*):

Restore dependencies
```
    cd "Sembium.ContentStorage.Service.AmazonLambda"
    dotnet restore
```

Execute unit tests
```
    cd "Sembium.ContentStorage.Service.AmazonLambda/test/Sembium.ContentStorage.Service.AmazonLambda.Tests"
    dotnet test
```

Deploy application
```
    cd "Sembium.ContentStorage.Service.AmazonLambda/src/Sembium.ContentStorage.Service.AmazonLambda"
