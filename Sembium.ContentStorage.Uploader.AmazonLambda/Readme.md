...
Once you have edited your template and code you can use the following command lines to deploy your application from the command line (these examples assume the project name is *Sembium.ContentStorage.Uploader.AmazonLambda*):

Restore dependencies
```
    cd "Sembium.ContentStorage.Uploader.AmazonLambda"
    dotnet restore
```

Execute unit tests
```
    cd "Sembium.ContentStorage.Uploader.AmazonLambda/test/Sembium.ContentStorage.Uploader.AmazonLambda.Tests"
    dotnet test
```

Deploy application
```
    cd "Sembium.ContentStorage.Uploader.AmazonLambda/src/Sembium.ContentStorage.Uploader.AmazonLambda"
